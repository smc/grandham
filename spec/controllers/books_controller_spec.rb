  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved book as @book" do
        ...
        post :create, {:book => { "grandham_id" => "invalid value" }}, valid_session
        assigns(:book).should be_a_new(Book)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested book" do
        ...
        Book.any_instance.should_receive(:update_attributes).with({ "grandham_id" => "MyString" })
        put :update, {:id => book.to_param, :book => { "grandham_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the book as @book" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Book.any_instance.stub(:save).and_return(false)
        put :update, {:id => book.to_param, :book => { "grandham_id" => "invalid value" }}, valid_session
        assigns(:book).should eq(book)
      end
